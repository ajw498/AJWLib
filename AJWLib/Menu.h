...
extern Desk_menu_ptr AJWLib_Menu_Create(char *title,char *desc,AJWLib_menufn selectfn,void *reference);
...
extern void AJWLib_Menu_ToggleTick(Desk_menu_ptr menu,int entry);

extern void AJWLib_Menu_ToggleShade(Desk_menu_ptr menu,int entry);
